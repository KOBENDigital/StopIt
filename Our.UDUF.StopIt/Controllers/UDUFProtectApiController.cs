...
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "UDUF.Protect")]
    public class UDUFProtectApiController : UDUFProtectApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public UDUFProtectApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
