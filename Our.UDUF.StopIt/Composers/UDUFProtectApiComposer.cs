...
namespace UDUF.Protect.Composers
{
	public class UDUFProtectApiComposer : IComposer
	{
		public void Compose(IUmbracoBuilder builder)
		{
			...
			builder.Services.Configure<SwaggerGenOptions>(opt =>
			{
				...
				{
					Title = "UDUFProtect Backoffice API",
					Version = "1.0",
				...
				opt.OperationFilter<UDUFProtectOperationSecurityFilter>();
			});

			builder.AddNotificationHandler<Umbraco.Cms.Core.Notifications.MediaSavingNotification, Our.UDUF.StopIt.NotificationHandlers.MediaSavingNotification>();
		}

		public class UDUFProtectOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
		{
		...
		public class CustomOperationHandler : OperationIdHandler
		{
			...
			{
				return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("UDUF.Protect.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
			}
